...
### 📖 [公式ドキュメント](https://docs.newapi.pro/ja/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/fjiangming/new-api)
...
- 📱 Telegram認証ログイン
- 🔑 OIDC統一認証
- 🔍 Key使用量クォータ照会（[neko-api-key-tool](https://github.com/fjiangming/neko-api-key-tool)と併用）
...
> [!TIP]
> **最新のDockerイメージ:** `fjiangming/new-api:latest`
...
| プロジェクト | 説明 |
|------|------|
| [neko-api-key-tool](https://github.com/fjiangming/neko-api-key-tool) | キー使用量クォータ照会ツール |
| [new-api-horizon](https://github.com/fjiangming/new-api-horizon) | New API高性能最適化版 |
...
[![スター履歴チャート](https://api.star-history.com/svg?repos=fjiangming/new-api&type=Date)](https://star-history.com/#fjiangming/new-api&Date)
...
**[公式ドキュメント](https://docs.newapi.pro/ja/docs)** • **[問題フィードバック](https://github.com/fjiangming/new-api/issues)** • **[最新リリース](https://github.com/fjiangming/new-api/releases)**
