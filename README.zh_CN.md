...
### 📖 [官方文档](https://docs.newapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/fjiangming/new-api)
...
- 📱 Telegram 授权登录
- 🔑 OIDC 统一认证
- 🔍 Key 查询使用额度（配合 [neko-api-key-tool](https://github.com/fjiangming/neko-api-key-tool)）
...
> [!TIP]
> **最新版 Docker 镜像：** `fjiangming/new-api:latest`
...
| 项目 | 说明 |
|------|------|
| [neko-api-key-tool](https://github.com/fjiangming/neko-api-key-tool) | Key 额度查询工具 |
| [new-api-horizon](https://github.com/fjiangming/new-api-horizon) | New API 高性能优化版 |
...
**[官方文档](https://docs.newapi.pro/zh/docs)** • **[问题反馈](https://github.com/fjiangming/new-api/issues)** • **[最新发布](https://github.com/fjiangming/new-api/releases)**
